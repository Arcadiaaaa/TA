...
<body>
    ...
    <div id="content" class="content">
        <!-- begin page-header -->
        <h1 class="page-header">Data Paket Photo</h1>
        <!-- end page-header -->

        <a href="formpaket.php"><button type="submit" class="btn btn-primary">Tambah Paket</button></a><br><br>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Data Paket Photo</h4>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="">
                                        ...
                                        <td> Rp. <?php echo number_format($hargapaket); ?> </td>
                                        <td> <?php echo $deskripsi; ?> </td>
                                        <td><img src="../img/datapaket/<?php echo $gambar; ?>" width="50"></td>

                                        <td><a href="editpaket.php?id=<?php echo $id; ?>">
                                                <button type="submit" class="btn btn-info">Ubah</button></a> &nbsp;
                                            <a href="../control/hapus.php?hal=paket&idhapuspaket=<?php echo $id; ?>">
