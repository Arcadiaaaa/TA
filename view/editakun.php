            ...
            <div class="col-md-20">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        ...
                        <?php
                        $idakn = $_GET['id'];
                        $result = mysqli_query($koneksi, "SELECT * FROM akun where id='$idakn' ");
                        while ($user_data = mysqli_fetch_array($result)) {
                            $idakn = $user_data['id'];
                            $namaadmin = $user_data['namaadmin'];
                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" method="POST" action="../control/update.php" name="demo-form">
                            ...
                            <div class="form-group" hidden>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="id" name="id" placeholder="Masukkan Nama Anda" data-parsley-required="true" value="<?php echo $idakn; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Nama Admin* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="namaadmin" name="namaadmin" placeholder="Masukkan Nama Anda" data-parsley-required="true" value="<?php echo $namaadmin; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="fullname">Username* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="username" name="username" placeholder="Masukkan Username Anda" data-parsley-required="true" value="<?php echo $username; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Password* :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="password" id="password" name="password" data-parsley-type="email" placeholder="Masukkan Password Anda" data-parsley-required="true" value="<?php echo $password; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4"></label>
                                <div class="col-md-6 col-sm-6">
                                    <button type="submit" class="btn btn-primary" id="updateakun" name="updateakun">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="editakun.php?id=<?php echo $id; ?>">
