                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" method="POST" action="../control/input.php" name="demo-form">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="Date" id="tanggaltranksaksi" name="tanggaltranksaksi" data-parsley-type="email" placeholder="Masukkan No Hp Anda" data-parsley-required="true" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <button type="submit" class="btn btn-primary" id="inputpemesanan" name="inputpemesanan">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
