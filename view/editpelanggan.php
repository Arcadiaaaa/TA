            ...
            <div class="col-md-20">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <?php
                        $idpemesanan = $_GET['id'];
                        $result = mysqli_query($koneksi, "SELECT * FROM pemesanan where id='$idpemesanan' ");
                        while ($user_data = mysqli_fetch_array($result)) {
                            $idpemesanan = $user_data['id'];
                            $tanggaltranksaksi = $user_data['tanggaltranksaksi'];
                            $nama = $user_data['nama'];
                        ...
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" method="POST" action="../control/update.php" name="demo-form">
                            ...
                            <div class="form-group" hidden>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" id="id" name="id" placeholder="Masukkan Nama Anda" data-parsley-required="true" value="<?php echo $idpemesanan; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="email">Tanggal Tranksaksi:</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="Date" id="tanggaltranksaksi" name="tanggaltranksaksi" data-parsley-type="email" placeholder="Masukkan No Hp Anda" data-parsley-required="true" value="<?php echo $tanggaltranksaksi; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <button type="submit" class="btn btn-primary" id="updatepemesanan" name="updatepemesanan">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
